...
public final class OrientGraphFactoryEx implements AutoCloseable, OrientGraphBaseFactory {
  ...
  public OrientGraphFactoryEx(OrientDB orientdb, String dbName, ODatabaseType type, String user, String password) {
  ...
  public OrientGraphFactoryEx(String url) {
    this(url, ADMIN, ADMIN);
  }

  public OrientGraphFactoryEx(String url, String user, String password) {
    this.user = user;
    this.password = password;
    this.labelAsClassName = true;
  ...
  public OrientGraphFactoryEx(Configuration config) {
  ...
  public OrientGraphFactoryEx setupPool(final int maxPartitionSize, final int max) {
    pool = new OPartitionedReCreatableDatabasePool(this.factory, dbName, type, user, password, max);
    return this;
  }
