...
//	private static final String strAuthen = "werwerewrw32423!@4#123";
	...
	public Document read(String SOAPAction, String body) throws Throwable {
...
//					StringReader sr = new StringReader(strResponse);
	...
	public String fromWebService(String SOAPAction, String body, String Node) throws Throwable {
		 
			Document document = read(SOAPAction, body);
			if (document != null) {
	...
	public String fromERP(String SOAPAction, String body, String Node) throws Throwable {
...
//							}
	...
	public <T> T callERP(Class<T> type, String method, String node, Map<String, String> params) throws JsonSyntaxException, Throwable {
		String body = "";
		try {
			body = FileHelper.ReadAllText(Utils.getCurrentDir() + "soapxml/" + method + ".xml");
			if (params != null)
		...
		return gson.fromJson(fromERP(method, body, node), type);
	}
}
