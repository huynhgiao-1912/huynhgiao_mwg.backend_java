...
//					}
	...
	public boolean updateObject(String indexDB, String esKeyTerm, String json) throws Exception {
		queueLock.lock();
		var update = new UpdateRequest(indexDB, esKeyTerm).doc(json, XContentType.JSON).docAsUpsert(true)
				.detectNoop(false);
