...
//	 static {
//	    eventClient = PredictionClient.getInstance();
//	 }
	...
	public List<RecommendationModel> GetRecommendationByItem(String item,int top) throws ExecutionException, InterruptedException, IOException {
