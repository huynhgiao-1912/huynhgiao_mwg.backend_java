...
public class NewsBO {
	...
	public NewsBO() {
		ListCategories = new ArrayList<NewsCategoryBO>();
		EventsList = new ArrayList<NewsEventBO>();
		ListRelatedNews = new ArrayList<NewsBO>();
	}
	...
	public Long UpdatedCustomerID;
	public Long DeletedCustomerID;
	public Long ActivedCustomerID;
	public String Tags;
